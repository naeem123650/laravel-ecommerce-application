            ...
            <div class="row">
                ...
                <div class="col-9">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="file" name="image[site_logo]" onchange="loadFile(event,'logoImg')"/>
                    </div>
                </div>
            </div>
            <div class="row mt-4">
                <div class="col-3">
                    @if (Setting::get('site_favicon') != null)
                        <img src="{{ asset('storage/'.Setting::get('site_favicon')) }}" id="faviconImg" style="width: 80px; height: auto;">
                    @else
                ...
                <div class="col-9">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="file" name="image[site_favicon]" onchange="loadFile(event,'faviconImg')"/>
                    </div>
                </div>
            </div>
        </div>
...
@push('scripts')
    ...
    <script src="{{ asset('helper/lokijs.min.js') }}"></script>
    <script src="{{ asset('helper/countries.js') }}"></script>
@endpush
