        ...
        <div class="tile-body">
            ...
            <div class="form-group pt-2">
                ...
                <select name="paypal_payment_method" id="paypal_payment_method" class="form-control">
                    <option value="1" {{ (Setting::get('paypal_payment_method')) == 1 ? 'selected' : '' }}>Enabled</option>
                    <option value="0" {{ (Setting::get('paypal_payment_method')) == 0 ? 'selected' : '' }}>Disabled</option>
            ...
            <div class="form-group">
                ...
                <input
                    ...
                    value="{{ Setting::get('paypal_secret_id') }}"
                    />
