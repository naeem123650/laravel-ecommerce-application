                ...
                <form action="{{ route('admin.categories.update') }}" method="POST" role="form" enctype="multipart/form-data">
                    ...
                    <div class="tile-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" rows="4" name="desc" id="desc">{{ old('desc', $targetCategory->desc) }}</textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="form-check">
                                <label class="form-check-label">
                                    ...
                                    @checked(old('featured',$targetCategory->featured))
                                    />Featured Category
                        ...
                        <div class="form-group">
                            <div class="form-check">
                                <label class="form-check-label">
                                    ...
                                    @checked(old('menu',$targetCategory->menu))
                                    />Show in Menu
                        ...
                        <div class="form-group">
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="checkbox" id="status" name="status" @checked(old('status',$targetCategory->status))/>Status
                                </label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <input class="form-control @error('image') is-invalid @enderror" type="file" id="image" name="image" onchange="loadFile(event,'categoryImage')"/>
